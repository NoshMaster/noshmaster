                ...
                <div className="hidden md:flex">
                    <Link className="mr-4 flex items-center space-x-2 lg:mr-6" to="#">
                        <svg className="h-6 w-6" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                            <path fill="#000000" d="
                                m50,0 m-15,50 a8,8,0,0,1,-16,0 a8,8,0,0,1,16,0 Z m30, 0 a8,8,0,0,1,16,0 a8,8,0,0,1,-16,0 z
                            "></path>
                        </svg>
                ...
                <div className="flex flex-1 items-center justify-between space-x-2 md:justify-end">
                    <Sheet>
                        <SheetTrigger asChild>
                            <button>
                                <svg className="h-6 w-6 flex md:hidden" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                                        <path fill="#000000" d="
                                            m50,0 m-15,50 a8,8,0,0,1,-16,0 a8,8,0,0,1,16,0 Z m30, 0 a8,8,0,0,1,16,0 a8,8,0,0,1,-16,0 z
                                        "></path>
                                </svg>
                        ...
                        <SheetContent side="left">
                            ...
                            <div className="grid gap-4 py-4">
                                <nav className="flex flex-col items-start gap-4 text-sm lg:gap-6">
                                    <Link className="text-sm font-medium hover:underline underline-offset-4" to="/docs/animation/fade-in">
                                        Docs
                                    </Link>
                                    <Link className="text-sm font-medium hover:underline underline-offset-4" to="/example">
                    ...
                    <nav>
                        <Link target="about:blank" to="https://github.com/NoshMaster/noshmaster">
                        ...
                        <Link target="about:blank" to="https://x.com/noshmaster">
                            <div className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 hover:bg-accent hover:text-accent-foreground py-2 h-8 w-8 px-0">
